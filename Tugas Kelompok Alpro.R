-----------ALGORITMA PEMROGRAMAN------------
  Kelompok 5
Nama anggota  : 1. Ratna Albar (3338250022)
2. Khalisa Adibah Nur Valmai (3338250024)
3. Putri Kalycia Nurjihan (3338250051)
Jurusan       : Statistika
Kelas         : 1A
...
Pengertian: Algoritma Greedy adalah metode pemecahan masalah yang mengikuti heuristik pemecahan masalah 
            dengan membuat pilihan lokal yang optimal pada setiap tahap,
...
Prinsip kerja: 1.Ia mengambil keputusan yang terlihat terbaik saat ini.
...
Tujuan Optimasi: Bukan sekadar "menyimpan data", melainkan meminimalkan WaktuAkses Rata-Rata atau Mean Retrieval Time (MRT).
...
Analogi Kasir: Bayangkan ada 2 orang di kasir. Orang A bawa 1 permen, Orang Bbawa 1 troli penuh belanjaan.
...
Latar Belakang Masalah: Ini adalah salah satu masalah optimasi paling terkenal dalam ilmu komputer dan matematika. 
                        Masalah ini merepresentasikan situasi Alokasi Sumber Daya Terbatas.
                        Bayangkan Anda memiliki wadah dengan kapasitas terbatas, dan banyak pilihan objek untuk dimasukkan. 
                        Setiap objek punya "biaya" (berat/ruang) dan"keuntungan" (nilai/harga). 
Konsep Kunci :
...
Ini disebut Densitas Nilai:
  ...
  Di meja prasmanan tersaji:
    ...
    Study Cases :Kapasitas Ransel (M): 20 kg
    Daftar Barang:
